...
class PaymentRequestsApi
{
    ...
    /**
     * Operation getDirectDebitForm
     *
     * Serves a form to initiate a direct debit payment.
     *
     * @param  string $id ID of the payment request to pay. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDirectDebitForm'] to see the possible values for this operation
     *
     * @throws \Nofrixion\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function getDirectDebitForm($id, string $contentType = self::contentTypes['getDirectDebitForm'][0])
    {
        $this->getDirectDebitFormWithHttpInfo($id, $contentType);
    }

    /**
     * Operation getDirectDebitFormWithHttpInfo
     *
     * Serves a form to initiate a direct debit payment.
     *
     * @param  string $id ID of the payment request to pay. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDirectDebitFormWithHttpInfo($id, string $contentType = self::contentTypes['getDirectDebitForm'][0])
    {
        $request = $this->getDirectDebitFormRequest($id, $contentType);
    ...
    /**
     * Operation getDirectDebitFormAsync
     *
     * Serves a form to initiate a direct debit payment.
     *
     * @param  string $id ID of the payment request to pay. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDirectDebitFormAsync($id, string $contentType = self::contentTypes['getDirectDebitForm'][0])
    {
        return $this->getDirectDebitFormAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDirectDebitFormAsyncWithHttpInfo
     *
     * Serves a form to initiate a direct debit payment.
     *
     * @param  string $id ID of the payment request to pay. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDirectDebitFormAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getDirectDebitForm'][0])
    {
        $returnType = '';
        $request = $this->getDirectDebitFormRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'getDirectDebitForm'
     *
     * @param  string $id ID of the payment request to pay. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDirectDebitForm'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDirectDebitFormRequest($id, string $contentType = self::contentTypes['getDirectDebitForm'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getDirectDebitForm'
            );
        }


        $resourcePath = '/api/v1/paymentrequests/{id}/directdebit/allinone';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation submitDirectDebit
     *
     * Processes information submitted through the direct debit payment form.
     *
     * @param  string $id ID of the payment request to pay. (required)
     * @param  string $merchant_id Merchant ID that this mandate is associated with. (required)
     * @param  string $first_name Customer&#39;s first name. (required)
     * @param  string $last_name Customer&#39;s last name. (required)
     * @param  string $address_line1 First line of the customer&#39;s address. (required)
     * @param  string $postal_code Customer&#39;s postal code. (required)
     * @param  string $city Customer&#39;s city. (required)
     * @param  string $country_code 2-character country code of the customer&#39;s bank account. (required)
     * @param  string $email_address Customer&#39;s email address. (required)
     * @param  string $currency Currency of the mandate. (required)
     * @param  float $amount Amount of the mandate. (required)
     * @param  \Nofrixion\Client\Model\NoFrixionBizBizModelsPaymentsCountry[] $countries countries (optional)
     * @param  string $address_line2 Second line of the customer&#39;s address. Optional. (optional)
     * @param  string $iban IBAN of the customer&#39;s bank account in case of EUR account. (optional)
     * @param  string $account_number Account number of the customer&#39;s bank account in case of GBP account. (optional)
     * @param  string $sort_code Sort code of the customer&#39;s bank account in case of GBP account. (optional)
     * @param  string $reference Field that you can use as reference. (optional)
     * @param  bool $is_recurring Indicates whether this mandate is single-use or recurring. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitDirectDebit'] to see the possible values for this operation
     *
     * @throws \Nofrixion\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function submitDirectDebit($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries = null, $address_line2 = null, $iban = null, $account_number = null, $sort_code = null, $reference = null, $is_recurring = null, string $contentType = self::contentTypes['submitDirectDebit'][0])
    {
        $this->submitDirectDebitWithHttpInfo($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries, $address_line2, $iban, $account_number, $sort_code, $reference, $is_recurring, $contentType);
    }

    /**
     * Operation submitDirectDebitWithHttpInfo
     *
     * Processes information submitted through the direct debit payment form.
     *
     * @param  string $id ID of the payment request to pay. (required)
     ...
     * @param  string $currency Currency of the mandate. (required)
     * @param  float $amount Amount of the mandate. (required)
     * @param  \Nofrixion\Client\Model\NoFrixionBizBizModelsPaymentsCountry[] $countries (optional)
     * @param  string $address_line2 Second line of the customer&#39;s address. Optional. (optional)
     * @param  string $iban IBAN of the customer&#39;s bank account in case of EUR account. (optional)
     * @param  string $account_number Account number of the customer&#39;s bank account in case of GBP account. (optional)
     * @param  string $sort_code Sort code of the customer&#39;s bank account in case of GBP account. (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitDirectDebitWithHttpInfo($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries = null, $address_line2 = null, $iban = null, $account_number = null, $sort_code = null, $reference = null, $is_recurring = null, string $contentType = self::contentTypes['submitDirectDebit'][0])
    {
        $request = $this->submitDirectDebitRequest($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries, $address_line2, $iban, $account_number, $sort_code, $reference, $is_recurring, $contentType);
    ...
    /**
     * Operation submitDirectDebitAsync
     *
     * Processes information submitted through the direct debit payment form.
     *
     * @param  string $id ID of the payment request to pay. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitDirectDebitAsync($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries = null, $address_line2 = null, $iban = null, $account_number = null, $sort_code = null, $reference = null, $is_recurring = null, string $contentType = self::contentTypes['submitDirectDebit'][0])
    {
        return $this->submitDirectDebitAsyncWithHttpInfo($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries, $address_line2, $iban, $account_number, $sort_code, $reference, $is_recurring, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation submitDirectDebitAsyncWithHttpInfo
     *
     * Processes information submitted through the direct debit payment form.
     *
     * @param  string $id ID of the payment request to pay. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitDirectDebitAsyncWithHttpInfo($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries = null, $address_line2 = null, $iban = null, $account_number = null, $sort_code = null, $reference = null, $is_recurring = null, string $contentType = self::contentTypes['submitDirectDebit'][0])
    {
        $returnType = '';
        $request = $this->submitDirectDebitRequest($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries, $address_line2, $iban, $account_number, $sort_code, $reference, $is_recurring, $contentType);
    ...
    /**
     * Create request for operation 'submitDirectDebit'
     *
     * @param  string $id ID of the payment request to pay. (required)
     * @param  string $merchant_id Merchant ID that this mandate is associated with. (required)
     * @param  string $first_name Customer&#39;s first name. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function submitDirectDebitRequest($id, $merchant_id, $first_name, $last_name, $address_line1, $postal_code, $city, $country_code, $email_address, $currency, $amount, $countries = null, $address_line2 = null, $iban = null, $account_number = null, $sort_code = null, $reference = null, $is_recurring = null, string $contentType = self::contentTypes['submitDirectDebit'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling submitDirectDebit'
            );
        }
        ...
        if ($merchant_id === null || (is_array($merchant_id) && count($merchant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $merchant_id when calling submitDirectDebit'
            );
        }
        ...
        if ($first_name === null || (is_array($first_name) && count($first_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $first_name when calling submitDirectDebit'
            );
        }
        if (strlen($first_name) > 256) {
            throw new \InvalidArgumentException('invalid length for "$first_name" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 256.');
        }
        if (!preg_match("/^[a-zA-Z0-9\\-,'. ]+$/", $first_name)) {
            throw new \InvalidArgumentException("invalid value for \"first_name\" when calling PaymentRequestsApi.submitDirectDebit, must conform to the pattern /^[a-zA-Z0-9\\-,'. ]+$/.");
        }
        
        // verify the required parameter 'last_name' is set
        if ($last_name === null || (is_array($last_name) && count($last_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $last_name when calling submitDirectDebit'
            );
        }
        if (strlen($last_name) > 256) {
            throw new \InvalidArgumentException('invalid length for "$last_name" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 256.');
        }
        if (!preg_match("/^[a-zA-Z0-9\\-,'. ]+$/", $last_name)) {
            throw new \InvalidArgumentException("invalid value for \"last_name\" when calling PaymentRequestsApi.submitDirectDebit, must conform to the pattern /^[a-zA-Z0-9\\-,'. ]+$/.");
        }
        
        // verify the required parameter 'address_line1' is set
        if ($address_line1 === null || (is_array($address_line1) && count($address_line1) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $address_line1 when calling submitDirectDebit'
            );
        }
        if (strlen($address_line1) > 100) {
            throw new \InvalidArgumentException('invalid length for "$address_line1" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 100.');
        }
        if (!preg_match("/^[a-zA-Z0-9\\-,'.\/ ]+$/", $address_line1)) {
            throw new \InvalidArgumentException("invalid value for \"address_line1\" when calling PaymentRequestsApi.submitDirectDebit, must conform to the pattern /^[a-zA-Z0-9\\-,'.\/ ]+$/.");
        }
        
        // verify the required parameter 'postal_code' is set
        if ($postal_code === null || (is_array($postal_code) && count($postal_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $postal_code when calling submitDirectDebit'
            );
        }
        if (strlen($postal_code) > 10) {
            throw new \InvalidArgumentException('invalid length for "$postal_code" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 10.');
        }
        if (!preg_match("/^[a-zA-Z0-9\\-,. \/]+$/", $postal_code)) {
            throw new \InvalidArgumentException("invalid value for \"postal_code\" when calling PaymentRequestsApi.submitDirectDebit, must conform to the pattern /^[a-zA-Z0-9\\-,. \/]+$/.");
        }
        
        // verify the required parameter 'city' is set
        if ($city === null || (is_array($city) && count($city) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $city when calling submitDirectDebit'
            );
        }
        if (strlen($city) > 128) {
            throw new \InvalidArgumentException('invalid length for "$city" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 128.');
        }
        if (!preg_match("/^[a-zA-Z0-9\\-,'. ]+$/", $city)) {
            throw new \InvalidArgumentException("invalid value for \"city\" when calling PaymentRequestsApi.submitDirectDebit, must conform to the pattern /^[a-zA-Z0-9\\-,'. ]+$/.");
        }
        
        // verify the required parameter 'country_code' is set
        if ($country_code === null || (is_array($country_code) && count($country_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $country_code when calling submitDirectDebit'
            );
        }
        if (strlen($country_code) > 2) {
            throw new \InvalidArgumentException('invalid length for "$country_code" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 2.');
        }
        
        // verify the required parameter 'email_address' is set
        if ($email_address === null || (is_array($email_address) && count($email_address) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_address when calling submitDirectDebit'
            );
        }
        ...
        if ($currency === null || (is_array($currency) && count($currency) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $currency when calling submitDirectDebit'
            );
        }
        ...
        if ($amount === null || (is_array($amount) && count($amount) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $amount when calling submitDirectDebit'
            );
        }


        if ($address_line2 !== null && strlen($address_line2) > 100) {
            throw new \InvalidArgumentException('invalid length for "$address_line2" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 100.');
        }
        if ($address_line2 !== null && !preg_match("/^[a-zA-Z0-9\\-,'.\/ ]+$/", $address_line2)) {
            throw new \InvalidArgumentException("invalid value for \"address_line2\" when calling PaymentRequestsApi.submitDirectDebit, must conform to the pattern /^[a-zA-Z0-9\\-,'.\/ ]+$/.");
        }
        
        if ($iban !== null && strlen($iban) > 34) {
            throw new \InvalidArgumentException('invalid length for "$iban" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 34.');
        }
        
        if ($account_number !== null && strlen($account_number) > 8) {
            throw new \InvalidArgumentException('invalid length for "$account_number" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 8.');
        }
        if ($account_number !== null && !preg_match("/^[0-9]*$/", $account_number)) {
            throw new \InvalidArgumentException("invalid value for \"account_number\" when calling PaymentRequestsApi.submitDirectDebit, must conform to the pattern /^[0-9]*$/.");
        }
        
        if ($sort_code !== null && strlen($sort_code) > 6) {
            throw new \InvalidArgumentException('invalid length for "$sort_code" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 6.');
        }
        if ($sort_code !== null && !preg_match("/^[0-9\\-]*$/", $sort_code)) {
            throw new \InvalidArgumentException("invalid value for \"sort_code\" when calling PaymentRequestsApi.submitDirectDebit, must conform to the pattern /^[0-9\\-]*$/.");
        }
        
        if ($reference !== null && strlen($reference) > 128) {
            throw new \InvalidArgumentException('invalid length for "$reference" when calling PaymentRequestsApi.submitDirectDebit, must be smaller than or equal to 128.');
        }
        ...
        // form params
        if ($countries !== null) {
            $formParams['Countries'] = ObjectSerializer::toFormValue($countries);
        }
        // form params
        if ($merchant_id !== null) {
        ...
        if ($address_line1 !== null) {
            $formParams['AddressLine1'] = ObjectSerializer::toFormValue($address_line1);
        }
        // form params
        if ($address_line2 !== null) {
            $formParams['AddressLine2'] = ObjectSerializer::toFormValue($address_line2);
        }
        // form params
        if ($postal_code !== null) {
        ...
        if ($account_number !== null) {
            $formParams['AccountNumber'] = ObjectSerializer::toFormValue($account_number);
        }
        // form params
        if ($sort_code !== null) {
            $formParams['SortCode'] = ObjectSerializer::toFormValue($sort_code);
        }
        // form params
        ...
        if ($is_recurring !== null) {
            $formParams['IsRecurring'] = ObjectSerializer::toFormValue($is_recurring);
        }
        // form params
        if ($currency !== null) {
