...
/**
 * NoFrixionMoneyMoovModelsAccountIdentifier Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionMoneyMoovModelsAccountIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.AccountIdentifier';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The type of the account identifier.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string $currency The currency for the account.
     *
     * @return self
     */
    ...
    /**
     * Gets display_summary
     *
     * @return string|null
     */
    public function getDisplaySummary()
    {
        return $this->container['display_summary'];
    }

    /**
     * Sets display_summary
     *
     * @param string|null $display_summary Summary of the account identifier's most important properties.
     *
     * @return self
     */
    public function setDisplaySummary($display_summary)
    {
        if (is_null($display_summary)) {
            array_push($this->openAPINullablesSetToNull, 'display_summary');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('display_summary', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['display_summary'] = $display_summary;

        return $this;
    }

    /**
     * Gets display_scan_summary
     *
     * @return string|null
     */
    public function getDisplayScanSummary()
    {
        return $this->container['display_scan_summary'];
    }

    /**
     * Sets display_scan_summary
     *
     * @param string|null $display_scan_summary display_scan_summary
     *
     * @return self
     */
    public function setDisplayScanSummary($display_scan_summary)
    {
        if (is_null($display_scan_summary)) {
            array_push($this->openAPINullablesSetToNull, 'display_scan_summary');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('display_scan_summary', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
