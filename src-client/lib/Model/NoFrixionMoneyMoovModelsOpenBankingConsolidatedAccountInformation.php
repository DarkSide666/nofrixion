<?php
/**
 * NoFrixionMoneyMoovModelsOpenBankingConsolidatedAccountInformation
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NoFrixionMoneyMoovModelsOpenBankingConsolidatedAccountInformation Class Doc Comment
 *
 * @category Class
 ...
 */
class NoFrixionMoneyMoovModelsOpenBankingConsolidatedAccountInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.OpenBanking.ConsolidatedAccountInformation';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Identifier of the consolidated account. When used in Get Account Transactions calls, the transactions   between the sub-accounts will not be reported.
     *
     * @return self
     */
