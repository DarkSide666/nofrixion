...
class NoFrixionMoneyMoovModelsPaymentRequestUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $payment_method_types The payment methods that the payment request supports. When setting using form data  should be supplied as a comma separated list, for example \"card, pisp, lightning\".
     *
     * @return self
     */
    public function setPaymentMethodTypes($payment_method_types)
    {
        ...
        $allowedValues = $this->getPaymentMethodTypesAllowableValues();
        if (!is_null($payment_method_types) && !in_array($payment_method_types, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'payment_method_types', must be one of '%s'",
