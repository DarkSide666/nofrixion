<?php
/**
 * NoFrixionMoneyMoovModelsBeneficiaryUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NoFrixionMoneyMoovModelsBeneficiaryUpdate Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionMoneyMoovModelsBeneficiaryUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.BeneficiaryUpdate';
    ...
    */
     ...
     *
     * @param string[]|null $source_account_ids ID of the accounts which are authorised to act as a source for the beneficiary.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The descriptive name for the beneficiary.
     *
     * @return self
     */
