<?php
/**
 * NoFrixionMoneyMoovModelsPaymentRequestsPaymentRequestAuthorization
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NoFrixionMoneyMoovModelsPaymentRequestsPaymentRequestAuthorization Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionMoneyMoovModelsPaymentRequestsPaymentRequestAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.PaymentRequests.PaymentRequestAuthorization';
    ...
    */
     ...
     *
     * @param string|null $payment_request_id The ID of the payment request the pisp authorization is for.
     *
     * @return self
     */
     ...
     * Sets occurred_at
     *
     * @param \DateTime|null $occurred_at Timestamp the pisp authorization occurred.
     *
     * @return self
     */
