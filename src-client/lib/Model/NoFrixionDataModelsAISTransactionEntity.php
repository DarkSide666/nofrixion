<?php
/**
 * NoFrixionDataModelsAISTransactionEntity
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NoFrixionDataModelsAISTransactionEntity Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionDataModelsAISTransactionEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.DataModels.AISTransactionEntity';
    ...
    protected static $attributeMap = [
        ...
        'supplier_updated_raw' => 'supplierUpdatedRaw',
    ...
    protected static $setters = [
        ...
        'supplier_updated_raw' => 'setSupplierUpdatedRaw',
    ...
    protected static $getters = [
        ...
        'supplier_updated_raw' => 'getSupplierUpdatedRaw',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('supplier_updated_raw', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $supplier_status supplier_status
     *
     * @return self
     */
    ...
    /**
     * Gets supplier_updated_raw
     *
     * @return string|null
     */
    public function getSupplierUpdatedRaw()
    {
        return $this->container['supplier_updated_raw'];
    }

    /**
     * Sets supplier_updated_raw
     *
     * @param string|null $supplier_updated_raw supplier_updated_raw
     *
     * @return self
     */
    public function setSupplierUpdatedRaw($supplier_updated_raw)
    {
        if (is_null($supplier_updated_raw)) {
            array_push($this->openAPINullablesSetToNull, 'supplier_updated_raw');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('supplier_updated_raw', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['supplier_updated_raw'] = $supplier_updated_raw;
