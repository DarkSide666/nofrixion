<?php
/**
 * NoFrixionMoneyMoovModelsOpenBankingPayee
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NoFrixionMoneyMoovModelsOpenBankingPayee Class Doc Comment
 *
 * @category Class
 ...
 */
class NoFrixionMoneyMoovModelsOpenBankingPayee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.MoneyMoov.Models.OpenBanking.Payee';
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\Nofrixion\Client\Model\NoFrixionMoneyMoovModelsOpenBankingAddress',
        'merchant_id' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('merchant_id', $data ?? [], '');
        $this->setIfExists('merchant_category_code', $data ?? [], '');
    }
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The account holder name of the beneficiary.
     *
     * @return self
     */
     ...
     *
     * @return \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsOpenBankingAccountIdentification[]
     */
     ...
     *
     * @param \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsOpenBankingAccountIdentification[] $account_identifications The account identifications that identify the Payee  bank account.
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsOpenBankingAddress|null
     */
     ...
     * Sets address
     *
     * @param \Nofrixion\Client\Model\NoFrixionMoneyMoovModelsOpenBankingAddress|null $address address
     *
     * @return self
     */
     ...
     * Sets merchant_id
     *
     * @param string|null $merchant_id The merchant ID is a unique code provided by the payment processor to the merchant.
     *
     * @return self
     */
     ...
     *
     * @param string|null $merchant_category_code The category code of the merchant in case the Payee is a business.
     *
     * @return self
     */
