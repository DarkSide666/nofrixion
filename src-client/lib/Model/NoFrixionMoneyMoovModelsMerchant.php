...
class NoFrixionMoneyMoovModelsMerchant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SUPPORTED_PAYMENT_METHODS_NONE = 'None';
    public const SUPPORTED_PAYMENT_METHODS_CARD = 'card';
    public const SUPPORTED_PAYMENT_METHODS_PISP = 'pisp';
    public const SUPPORTED_PAYMENT_METHODS_LIGHTNING = 'lightning';
    public const SUPPORTED_PAYMENT_METHODS_CARDTOKEN = 'cardtoken';
    public const SUPPORTED_PAYMENT_METHODS_APPLE_PAY = 'applePay';
    public const SUPPORTED_PAYMENT_METHODS_GOOGLE_PAY = 'googlePay';
    public const SUPPORTED_PAYMENT_METHODS_DIRECT_DEBIT = 'directDebit';
     ...
     * @return string[]
     */
    public function getSupportedPaymentMethodsAllowableValues()
    {
        return [
            self::SUPPORTED_PAYMENT_METHODS_NONE,
            self::SUPPORTED_PAYMENT_METHODS_CARD,
            self::SUPPORTED_PAYMENT_METHODS_PISP,
            self::SUPPORTED_PAYMENT_METHODS_LIGHTNING,
            self::SUPPORTED_PAYMENT_METHODS_CARDTOKEN,
            self::SUPPORTED_PAYMENT_METHODS_APPLE_PAY,
            self::SUPPORTED_PAYMENT_METHODS_GOOGLE_PAY,
            self::SUPPORTED_PAYMENT_METHODS_DIRECT_DEBIT,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSupportedPaymentMethodsAllowableValues();
        if (!is_null($this->container['supported_payment_methods']) && !in_array($this->container['supported_payment_methods'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'supported_payment_methods', must be one of '%s'",
                $this->container['supported_payment_methods'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string|null $supported_payment_methods The payment methods that are configured and supported for this merchant.  Returned as a comma-separated list of PaymentMethodTypeEnum values.
     *
     * @return self
     */
    public function setSupportedPaymentMethods($supported_payment_methods)
    {
        ...
        $allowedValues = $this->getSupportedPaymentMethodsAllowableValues();
        if (!in_array($supported_payment_methods, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'supported_payment_methods', must be one of '%s'",
