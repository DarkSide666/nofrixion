<?php
/**
 * NoFrixionDataModelsBeneficiaryEventEntity
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NoFrixionDataModelsBeneficiaryEventEntity Class Doc Comment
 *
 * @category Class
 * @package  Nofrixion\Client
 * @author   OpenAPI Generator team
 ...
 */
class NoFrixionDataModelsBeneficiaryEventEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NoFrixion.DataModels.BeneficiaryEventEntity';
    ...
    */
     ...
     *
     * @param string|null $source_accounts_hash source_accounts_hash
     *
     * @return self
     */
